...
Common Crawl \cite{commoncrawl} is a freely accessible corpus of \replace{the}{} pages across the web. Their data \replace{are}{is} updated and released on a monthly basis. Many researchers have used the data for \replace{varying}{various} purposes~\cite{smith2013dirt}~\cite{muhleisen2012web}~\cite{singh2012wikilinks}. Since the project requires us to crawl the web (see section {\color{red} FIXME}), the corpus is a very suitable candidate for us to work with.

The data of Common Crawl \replace{come}{comes} in three formats\footnote{\url{https://gist.github.com/Smerity/e750f0ef0ab9aa366558}}: 
\begin{description}
