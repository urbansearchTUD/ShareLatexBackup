...
We found the open data repository of the "Centraal Bureau voor de Statistieken" (CBS) to be a source of quality documents that could be used as training data for the classifier. The 
