...
As explained in section \ref{sec:design-goals}, data sources should be plugable. However, a corpus of documents is needed to base the project on initially. In this section, we will decide what data source to use. 

\subsubsection{Common Crawl} \label{sec:commoncrawl}
Common Crawl \cite{commoncrawl} is a freely accessible corpus of pages across the web, updated and released on a monthly basis. Many researchers have used the data for various purposes~\cite{smith2013dirt, muhleisen2012web, singh2012wikilinks}. Since the project requires analyse on a very large set of documents, the corpus is a very suitable candidate for us to work with. \\
