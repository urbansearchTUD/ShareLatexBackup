...
As explained in section \ref{sec:project-evaluation} all of the design goals except the exporting of data were met. Whilst there are still some issues, the most important requirements also passed.  %When looking at the subproblems in section 3.2, filtering was discussed in, classification in, storing data in ? and data visualisation % export in ?. We can now reflect on the problem definition from 3.1: "How can open data be leveraged such that a metric for the strength of relationships between cities can be defined and visualised?"  
