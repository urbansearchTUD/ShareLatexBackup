...
Relations are shown as poly-lines on the map. The total strength of the relation (which will be discussed below) is used to set an opacity for the relation. A low opacity indicates an strong total strength of the relation and vice versa.
...
The dropdown shown in the relations control interface provides a way to scale the relation totals. Lets
