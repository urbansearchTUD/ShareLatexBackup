...
The most important issue that we faced, for which only a partial work around was found, is data inconsistency with multiprocessing. As will be explained later in section \ref{sec:main-app}, we use multiprocessing to glue the system together efficiently. However, it turned out that 
