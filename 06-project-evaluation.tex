...
One ethical issue is due to the storing of data. Since we store random webpages we do not know wether or not these pages may contain private or copyrighted data. For instance  
