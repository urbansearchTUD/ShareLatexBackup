...
1 Show all connections         & Fail        & \begin{tabular}[c]{@{}l@{}}Theoreticly it is possible to do this, but it would result in a map on which relationships can not be \\ differentiated from each other due to the large amount the system was not build for.\end{tabular} \\
